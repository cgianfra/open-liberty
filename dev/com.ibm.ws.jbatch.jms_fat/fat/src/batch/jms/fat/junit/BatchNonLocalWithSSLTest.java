...
public class BatchNonLocalWithSSLTest {
    ...
    public static void afterClass() throws Exception {
        ...
        if (messageEngineServer != null && messageEngineServer.isStarted()) {
            messageEngineServer.stopServer("CWSIJ0077E", "CWSIC2019E", "CWSIJ0044E", "CWSIJ0047E");
        }
    }
    ...
    private static void log(String method, Object msg) {
        Log.info(BatchNonLocalWithSSLTest.class, method, String.valueOf(msg));
    }
    ...
    public void testStopJobExecutionRedirect() throws Exception {
        ...
        HttpURLConnection con = HttpUtils.getHttpConnection(dispatcherUtils.buildURL("/ibm/api/batch/jobexecutions/" + jobExecution.getJsonNumber("executionId").longValue()
                                                                                     + "?action=stop&permitRedirect=true"),
    ...
    /**
     * Test that sending a STOP request to the dispatcher will forward the request to the endpoint
     */

    @Test
    public void testStopJobExecutionForwardRequest() throws Exception {
     ...
     */
    @Test
    public void testStopJobInstanceForwardRequest() throws Exception {
        ...
        // The job should be running on the endpoint (listenerServer).
        // Now try to stop it via the dispatcher. Should get a 200 after dispatcher makes the call to the endpoint.
        HttpURLConnection con = HttpUtils.getHttpConnection(dispatcherUtils.buildURL("/ibm/api/batch/jobinstances/" + jobInstance.getJsonNumber("instanceId").longValue()
                                                                                     + "?action=stop"),
                                                            HttpURLConnection.HTTP_OK,
                                                            new int[0],
    ...
    public void testJoblogsRedirect() throws Exception {
        ...
        BatchRestUtils endpointUtils = new BatchRestUtils(endpointServer);
        String expectedLocation = endpointUtils.buildURLUsingIPAddr("/ibm/api/batch/jobexecutions/" + jobExecution.getJsonNumber("executionId").longValue()
                                                                    + "/joblogs?permitRedirect=true").toString();
    ...
    public void testJoblogsRedirectWithQueryParms() throws Exception {
        ...
        // Now try to get the joblogs via the dispatcher. Should get a 302 redirect back.
        HttpURLConnection con = HttpUtils.getHttpConnection(dispatcherUtils.buildURL("/ibm/api/batch/jobexecutions/" + jobExecution.getJsonNumber("executionId").longValue()
                                                                                     + "/joblogs?type=text&part=part.1.log&permitRedirect=true"),
                                                            HttpURLConnection.HTTP_MOVED_TEMP,
                                                            new int[0],
                                                            10,
                                                            HTTPRequestMethod.GET,
        ...
        BatchRestUtils endpointUtils = new BatchRestUtils(endpointServer);
        String expectedLocation = endpointUtils.buildURLUsingIPAddr("/ibm/api/batch/jobexecutions/" + jobExecution.getJsonNumber("executionId").longValue() +
                                                                    "/joblogs?type=text&part=part.1.log&permitRedirect=true").toString();
    ...
    @Test
    public void testJobLogsForwardRequestWithQueryParms() throws Exception {
    ...
    public void testJoblogsJobInstanceRedirectWithQueryParms() throws Exception {
        ...
        // Now try to get the joblogs via the dispatcher. Should get a 302 redirect back.
        HttpURLConnection con = HttpUtils.getHttpConnection(dispatcherUtils.buildURL("/ibm/api/batch/jobinstances/" + jobInstance.getJsonNumber("instanceId").longValue()
                                                                                     + "/joblogs?type=zip&permitRedirect=true"),
                                                            HttpURLConnection.HTTP_MOVED_TEMP,
                                                            new int[0],
                                                            10,
                                                            HTTPRequestMethod.GET,
        ...
        BatchRestUtils endpointUtils = new BatchRestUtils(endpointServer);
        String expectedLocation = endpointUtils.buildURLUsingIPAddr("/ibm/api/batch/jobinstances/" + jobInstance.getJsonNumber("instanceId").longValue()
                                                                    + "/joblogs?type=zip&permitRedirect=true").toString();
    ...
    @Test
    public void testJoblogsJobInstanceForwardRequestWithQueryParms() throws Exception {
    ...
    public void testJobPurgeRedirect() throws Exception {
        ...
        HttpURLConnection con = HttpUtils.getHttpConnection(dispatcherUtils.buildURL("/ibm/api/batch/jobinstances/" + jobInstanceId + "?permitRedirect=true"),
                                                            HttpURLConnection.HTTP_MOVED_TEMP,
                                                            new int[0],
                                                            10,
     ...
     */
    @Test
    public void testJobPurgeForwardRequestt() throws Exception {
